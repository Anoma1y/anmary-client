...
export default class List extends Component {
  ...
  // )
  //
  // renderTableContent = (permissions) => this.props.Products_List.operations
  //   .map((operation) => {
  //
  //     const { id, type, category, sum, currency, created_at, shift, tags, files } = operation;
  //     const operation_type = _.find(this.props.Admin.operation_type, { id: type }).label;
  ...
  //                       variant={'raised'}
  //                       color={'primary'}
  //                       disabled={!this.props.Admin.hasActiveShift}
